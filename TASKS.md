...
| ID | Status | Task | Notes |
| --- | --- | --- | --- |
| T801 | TODO | Implement minimal admin management screens | Phase 10A Admin Doctor Management MVP and Phase 10B Admin Specialty Management MVP are completed. Remaining admin scope includes admin schedule management, admin patient management, admin consultation management, admin chat/message/file access, break-glass audited access, invite/password reset flow, 2FA, billing/payment, hard deletion workflows, and broader audit-log workflows. |

  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        {
          title: "Доступность",
          body: "Во время разработки и тестирования MVP может временно не работать, содержать неполные функции или изменяться без предварительного уведомления. Официальные электронные рецепты, полноценные процессы удаления данных и правила хранения для реальной эксплуатации пока не реализованы.",
        },
        {

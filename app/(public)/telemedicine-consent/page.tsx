    ...
    <LegalPage
      ...
      sections={[
        ...
        },
        {
          ...
          body: "Рекомендации врача и итоги консультации в этом MVP являются информационными результатами рабочего процесса. Они не представляют собой медицинскую документацию для реального оказания помощи или официальный электронный рецепт и не заменяют экстренную либо очную помощь, когда она необходима.",
        },
        {
          title: "Рецепты и юридически значимые медицинские процессы",
          body: "Работа с официальными рецептами, юридически значимой медицинской документацией и процессами клинического и нормативного соответствия для реальной эксплуатации пока не реализована полностью.",
        },
        {
          title: "Видеосвязь",

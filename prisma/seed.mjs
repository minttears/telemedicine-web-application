...
const seedDoctors = [
  {
    bio: "Консультирует по общим вопросам здоровья, профилактике, распространённым симптомам и дальнейшему наблюдению.",
    education: "Медицинский учебный центр «Медлайн»",
    email: "doctor@example.local",
    experienceYears: 8,
    name: "Иванов Алексей Сергеевич",
  ...
  {
    bio: "Помогает с вопросами профилактики, распространёнными симптомами и наблюдением за состоянием здоровья.",
    education: "Академия семейной медицины «Нортбридж»",
  ...
  {
    bio: "Консультирует по вопросам головной боли, головокружения, мигрени и других неврологических симптомов.",
    education: "Неврологический центр «Вестпорт»",
    email: "dr.amina.patel@example.local",
    experienceYears: 10,
    name: "Соколова Мария Викторовна",
    specialtySlug: "neurology",
    title: "Врач-невролог",
  },
  {
    bio: "Консультирует по вопросам сыпи, акне, зуда, выпадения волос и изменений родинок.",
    education: "Клинический центр дерматологии «Ривер-Сити»",
  ...
  {
    bio: "Консультирует по вопросам температуры и кашля у детей, вакцинации и дальнейшего педиатрического наблюдения.",
    education: "Учебный центр детской больницы «Гринфилд»",
  ...
  {
    bio: "Помогает с вопросами пищеварения, включая боль в животе, тошноту, диарею, запор и изжогу.",
    education: "Гастроэнтерологический центр «Харбор»",
    email: "dr.lucia.fernandez@example.local",
    experienceYears: 13,
    name: "Васильева Ольга Романовна",
    specialtySlug: "gastroenterology",
    title: "Врач-гастроэнтеролог",
  },
  {
    bio: "Консультирует по вопросам гормонального здоровья, щитовидной железы, диабета, обмена веществ и изменения веса.",
    education: "Институт эндокринологии «Саммит»",
  ...
  {
    bio: "Консультирует по вопросам боли в спине, суставах и мышцах, а также травм и растяжений.",
    education: "Центральная академия ортопедии",
  ...
  {
    bio: "Консультирует по вопросам боли в ухе, снижения слуха, боли в горле и других ЛОР-симптомов.",
    education: "Учебный центр оториноларингологии «Истсайд»",
    email: "dr.ethan.brooks@example.local",
    experienceYears: 7,
    name: "Фёдоров Андрей Павлович",
    specialtySlug: "ent",
    title: "Врач-оториноларинголог",
  },
  {
    bio: "Консультирует по вопросам покраснения глаз, нечёткого зрения и дальнейшего обследования зрения.",
  ...
  {
    bio: "Консультирует по вопросам боли и дискомфорта при мочеиспускании, частого мочеиспускания и других урологических симптомов.",
    education: "Центр подготовки по урологии «Стоунбридж»",
    email: "dr.julian.price@example.local",
    experienceYears: 12,
    name: "Никитин Артём Александрович",
    specialtySlug: "urology",
    title: "Врач-уролог",
  },
  {
    bio: "Консультирует по вопросам женского здоровья, профилактики и планирования дальнейшего обследования.",
    education: "Центр женского здоровья «Роузвуд»",
    email: "dr.ines.romero@example.local",
    experienceYears: 11,
    name: "Комарова Екатерина Дмитриевна",
    specialtySlug: "gynecology",
    title: "Врач-гинеколог",
  },
  {
    bio: "Консультирует по вопросам аллергии, иммунных реакций, сезонных симптомов и подбора дальнейшего обследования.",
    education: "Центр аллергологии и иммунологии «Норт-Кост»",
    email: "dr.aaron.lee@example.local",
    experienceYears: 9,
    name: "Захаров Михаил Евгеньевич",
    specialtySlug: "allergy-immunology",
    title: "Врач аллерголог-иммунолог",
  },
  {
    bio: "Помогает с тревожностью, стрессом, эмоциональным состоянием, нарушениями сна и вопросами психологической поддержки.",
    education: "Институт клинической психологии «Сидар»",
    email: "dr.hannah.nguyen@example.local",
    experienceYears: 8,
    name: "Громова Татьяна Владимировна",
    specialtySlug: "psychology",
    title: "Клинический психолог",
  },
  {
    bio: "Помогает с вопросами питания, изменения веса, планирования рациона и образа жизни.",
    education: "Центр диетологии «Эвергрин»",
    email: "dr.peter.walsh@example.local",
    experienceYears: 6,
    name: "Данилин Даниил Данилович",

...
- Doctor schedule management and patient booking availability use the same 5-minute minimum lead time; future `AVAILABLE` slots remain protected by status and overlap checks
